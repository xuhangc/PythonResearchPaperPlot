...
plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-6 利用互补色配色方案绘制的可视化配图示例_a.pdf',bbox_inches='tight')
plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-6 利用互补色配色方案绘制的可视化配图示例_a.png', 
...
plt.tight_layout()
plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-6 利用互补色配色方案绘制的可视化配图示例_b.pdf',bbox_inches='tight')
plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-6 利用互补色配色方案绘制的可视化配图示例_b.png', 
             bbox_inches='tight',dpi=300)
plt.show()           