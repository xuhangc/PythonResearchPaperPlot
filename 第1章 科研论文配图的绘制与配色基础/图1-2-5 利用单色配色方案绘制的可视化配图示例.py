...
#plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-5 利用单色配色方案绘制的可视化配图示例_a.png',
            # bbox_inches='tight',dpi=300)
plt.show()
#
# #图1-2-5 利用单色配色方案绘制的可视化配图示例_b
#
# sizes = [20, 40, 25, 15]
# labels = ['A','B','C','D',]
# colors=["#1826B0","#4C59D8","#717BD8","#081272"]
...
# plt.tight_layout()
# #plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-5 利用单色配色方案绘制的可视化配图示例_b.pdf',bbox_inches='tight')
# #plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-5 利用单色配色方案绘制的可视化配图示例_b.png',
#              #bbox_inches='tight',dpi=300)
#plt.show()