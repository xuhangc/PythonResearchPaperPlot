...
plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-7 利用等距三角配色方案绘制的可视化配图示例_a.pdf',bbox_inches='tight')
plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-7 利用等距三角配色方案绘制的可视化配图示例_a.png', 
             bbox_inches='tight',dpi=300)
plt.show()
             
             

#图1-2-7 利用等距三角配色方案绘制的可视化配图示例_b
sizes = [20, 50, 30]
labels = ['A','B','C']
colors=["#1D1AB2","#C9F600","#FF4C00"]
...
plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-7 利用等距三角配色方案绘制的可视化配图示例_b.pdf',bbox_inches='tight')
plt.savefig(r'r"\第1章 科研论文配图的绘制与配色基础\图1-2-7 利用等距三角配色方案绘制的可视化配图示例_b.png', 
             bbox_inches='tight',dpi=300)
plt.show()
