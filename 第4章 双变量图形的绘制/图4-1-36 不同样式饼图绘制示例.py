...
fig.savefig('\第4章 双变量图形的绘制\图4-1-36 不同样式饼图绘制示例_a.pdf',bbox_inches='tight')
fig.savefig('\第4章 双变量图形的绘制\图4-1-36 不同样式饼图绘制示例_a.png', 
...
ax.legend(labels,loc ='upper left',fontsize=9,handlelength=1.2,handleheight=1.2)
plt.tight_layout()
fig.savefig('\第4章 双变量图形的绘制\图4-1-36 不同样式饼图绘制示例_b.pdf',bbox_inches='tight')
fig.savefig('\第4章 双变量图形的绘制\图4-1-36 不同样式饼图绘制示例_b.png', 
            bbox_inches='tight',dpi=300)
plt.show()
# c）纹理填充样式饼图
...
fig.savefig('\第4章 双变量图形的绘制\图4-1-36 不同样式饼图绘制示例_c.pdf',bbox_inches='tight')
fig.savefig('\第4章 双变量图形的绘制\图4-1-36 不同样式饼图绘制示例_c.png', 
            bbox_inches='tight',dpi=300)
plt.show()